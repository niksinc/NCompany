        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Add Department <small>Nks Inc.</small></h3>
			 			</div>
			    		...
			    		<form role="form">
			                ...
			                <input type="text" name="deptName" id="deptName" class="form-control input-sm" placeholder="Department Name">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
