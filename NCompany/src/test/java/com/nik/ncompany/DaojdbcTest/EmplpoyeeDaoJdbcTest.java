...
public class EmplpoyeeDaoJdbcTest {
	...
	public void setup() {
		/*
		 * We will use this Employee in various tests. The student already be in
		 * the database
		 */
	...
	/*
	 * The following test demonstrate the expected employee is kin the database
	 * or not if the given employee is not in the database then the test will
	 * failed
	 */
	@Test
	...
	/*
	 * The Following] test is expect the illegal argument id the employee object
